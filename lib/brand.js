...
export const LAYOUTS = ['cover', 'text', 'quote', 'number', 'method', 'list', 'definition', 'end'];
...
export function layName(l) {
  return ({ cover: 'Couverture', text: 'Texte', quote: 'Citation', number: 'Chiffre', method: 'Méthode', list: 'Liste', definition: 'Définition', end: 'Fin / CTA' })[l] || l;
}
