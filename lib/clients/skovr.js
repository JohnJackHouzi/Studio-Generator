...
Ton de marque : expert, direct, sans jargon inutile. Tu dis la verite sur le referencement avec des donnees concretes. Pas de fioritures, pas de promesses vides. Apostrophes droites. Pas de tiret cadratin. CTA toujours : Scanner mon site sur skovr.fr.`,
  ...
  categories: {
    c1: {
      ...
      bg: '#0A0A0A', ink: '#FFFFFF', accent: '#B1338A', subt: '#8A8A8A',
      cta: 'SCANNER',
      prompt: `Carrousel autour d'une statistique ou donnee choc sur le SEO, le GEO ou la visibilite web. Fond sombre, accent fuchsia.`,
    },
    c2: {
    ...
    c3: {
      ...
      bg: '#050D1A', ink: '#FFFFFF', accent: '#3B82F6', subt: '#8A93A0',
      cta: 'DECOUVRIR',
    ...
    c7: {
      ...
      bg: '#12100A', ink: '#FFFFFF', accent: '#F59E0B', subt: '#968B72',
      cta: 'AUDIT',
