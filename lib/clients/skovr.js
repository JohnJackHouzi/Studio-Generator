...
const LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 60" width="150" height="38" role="img" aria-label="SK:VR">
  <text x="0" y="48" font-family="'Geist','Inter',system-ui,sans-serif" font-weight="700" font-size="52" letter-spacing="2" fill="#FFFFFF">SK</text>
  <text x="134" y="48" font-family="'Geist','Inter',system-ui,sans-serif" font-weight="700" font-size="52" fill="#B1338A">:</text>
  <text x="163" y="48" font-family="'Geist','Inter',system-ui,sans-serif" font-weight="700" font-size="52" letter-spacing="2" fill="#FFFFFF">VR</text>
</svg>`;
...
Ton de marque : expert, direct, sans jargon inutile. Tu dis la vérité sur le référencement avec des données concrètes. Pas de fioritures, pas de promesses vides. Apostrophes droites. Pas de tiret cadratin. 1 à 3 emojis max. CTA toujours "→ skovr.fr".`,
  ...
  // postiz: { ig: 'TON_ID_CANAL_IG', fb: '' }, // à remplir après connexion Postiz
