...
// Réutilise le skin « tech / dashboard » de Skovr (decor.style: 'skovr').
...
const studjoow = {
  ...
  categories: {
    c1: { name: 'Fuchsia · sombre', sub: 'RÉALISATION', bg: '#16060F', ink: '#FFFFFF', accent: '#B1338A', subt: '#9C8893', cta: 'PROJET', prompt: `Carrousel autour d'une réalisation ou d'un résultat client Studjoow. Fond teinté fuchsia.` },
